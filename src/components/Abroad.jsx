      ...
      <div className="relative">
        ...
        >
          {countries.map((country, index) => (
            <div
              key={index}
              className="bg-slate-100 rounded-lg shadow-md p-4 flex-shrink-0 w-80 sm:w-96 sm:h-auto transition-all duration-300"
            >
              <img
                src={country.image}
                alt={country.title}
                className="w-full h-48 object-cover rounded-t-lg transition-transform transform hover:scale-110 duration-300"
              />
              <div className="p-4">
